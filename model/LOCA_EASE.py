...
class LOCA_EASE(BaseRecommender):
    ...
    def predict(self, user_ids, eval_pos_matrix, eval_items=None):
        ...
        # ====== global output
        with open(os.path.join(self.dataset.data_dir, self.dataset.data_name, 'output', self.embedding + '_output.p'), 'rb') as f:
    ...
    def load_embedding(self, embedding_type):
        with open(os.path.join(self.dataset.data_dir, self.dataset.data_name, 'output', embedding_type + '_output.p'), 'rb') as f:
